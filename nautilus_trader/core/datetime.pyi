...
def dt_to_unix_nanos(dt: pd.Timestamp | dt.datetime | str | float) -> int: ...
...
def maybe_dt_to_unix_nanos(dt: pd.Timestamp | dt.datetime | str | float | None) -> int | None: ...
...
def time_object_to_dt(
    time_object: pd.Timestamp | dt.datetime | str | float | None,
) -> pd.Timestamp | None: ...
def max_date(
